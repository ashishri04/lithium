...
const myNewMW = function (req, res, next) {
    console.log("Hi I am a middleware named myNewMW")
    //const headerValidation =(req,res,next)=>{
    let isFreeAppUser = req.headers.isFreeappuser;
        req.body["isFreeAppUser"] = isFreeAppUser; 
    if (isFreeAppUser ==="true" ||  isFreeAppUser === "false") {
...
module.exports.myNewMW = myNewMW
